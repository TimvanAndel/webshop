    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <a href="user_toevoegen" class="btn btn-primary">Gebruiker Toevoegen</a><br>
          ...
          <div class="col-md-4" style="float: left;">
            <div class="card mb-4 shadow-sm" >
              ...
              <div class="card-body"> 
                ...
                <?php 
                    echo '<a href=" user_verwijderen?del='.$user['id'].'" class="del_btn" style="float: right;margin-right: 20px">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <?='<a href=" user_wijzigen?info='.$user['id'].'" class="del_btn" style="margin-top: 20px;">
