...
$id =   $_GET['info'];
$qry = $con->query("SELECT * FROM category WHERE id= $id");
...
<html lang="en">
  <head>
    ...
    <title>Tim van Andel - Categorie</title>
  ...
  <body>
    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          <h1 class="jumbotron-heading">Catogorie Wijzigen</h1>
        </div>
      </section>
    ...
    <!-- 
     ...
     <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="InputName" aria-describedby="Name" name="category_name" value="<?= $category['category_name']; ?>">
        </div>

        <div class="form-group">
            <label for="inputDescription">Beschrijving</label>
            <input type="text"  class="form-control" id="InputDescription" aria-describedby="Description" name="category_description" value="<?= $category['description']; ?>">
        </div>

        <div class="form-group">
            <label for="inputActive">Actief: 1= Actief | 2= Niet Actief |</label>
            <input type="text" class="form-control" id="InputActive" aria-describedby="Active" name="category_active" value="<?= $category['active']; ?>">
        </div>
