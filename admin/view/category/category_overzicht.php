    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <a href="category_toevoegen" class="btn  btn-primary">Catogorie Toevoegen</a><br>
          ...
          <div class="col-md-4" style="float: left;">
            <div class="card mb-4 shadow-sm" >
              ...
              <div class="card-body"> 
                ...
                <?php 
                    echo '<a href=" category_verwijderen?del='.$category['id'].'" class="del_btn" style="float: right;margin-right: 20px">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">  
                  <?='<a href=" category_wijzigen?info='.$category['id'].'" class="del_btn" style="margin-top: 20px;">
